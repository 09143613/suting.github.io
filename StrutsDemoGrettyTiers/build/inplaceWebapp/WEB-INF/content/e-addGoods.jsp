		...
		$(function(){
			...
			$('#dg').datagrid({
				...
				columns:[[
		          ...
		          {field:'photo',title:'商品图片',width:200,formatter:function(value, rec){//使用formatter格式化刷子
...
<!-- 工具条  -->
<div id="toolbar">
	<a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-add" onclick="" id="add" plain="true">添加商品</a> 
</div>    

<table id="dg" class="easyui-datagrid" toolbar="#toolbar"></table>	

<!--添加商品窗口-->
<div id="w" display="none" class="easyui-window" title="添加商品" collapsible="false" minimizable="false"
	...
	<div class="easyui-layout" fit="true">
        ...
        <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;"> 
        	<form method="post" >
    			<a id="btnEp" class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onclick="save()">保存</a> 
