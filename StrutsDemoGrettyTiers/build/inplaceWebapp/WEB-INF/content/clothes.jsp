		...
		<div class="col-lg-8">
			<div class="panel panel-default">
				...
				<ul id="goods" class="nav nav-pills" role="tablist">
					...
					<li><a href="#pj" role="tab" data-toggle="pill">累计评价（3303）</a></li>
					...
					<div id="mygoods" class="tab-content">
						...
						<div class="tab-pane fade" id="pj">
							...
							<table class="table-responsive table">
								<tr>
									<td width="200px">全部评价（3303）</td>
								</tr>
								<tr>
									<td id="toux">
										<img class="img-responsive" alt="头像" src="images/makeup/meiji1/tx1.jpg" />
									</td>
								</tr>
								<tr>
									<td width="100px" height="30px" id="uname">用户名</td>
									<td width="100px" height="30px" id="time">时间</td>
								</tr>
								<tr>
									<td id="pjsp">用户评价用户评价用户评价用户评价用户评价用户评价用户评价</td>
								</tr>
								<tr>
									<td id="pj-img">
										<img id="pjimg" src="images/makeup/meiji1/dzk1.jpg" alt="img" class="img-responsive" />
										<input type="hidden" value="0" />
										<img id="yc" src="images/makeup/meiji1/dzk1.jpg" alt="img" class="img-responsive" />
									</td>
								</tr>
							</table>
						</div>
